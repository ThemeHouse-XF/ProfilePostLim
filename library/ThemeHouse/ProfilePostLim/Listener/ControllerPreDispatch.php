...
class ThemeHouse_ProfilePostLim_Listener_ControllerPreDispatch extends ThemeHouse_Listener_ControllerPreDispatch
{
    ...
    {
        $controllerPreDispatch = new ThemeHouse_ProfilePostLim_Listener_ControllerPreDispatch($controller, $action);
